  ...
  if (!emailExists) {
        ...
        showDialog<void>(
          ...
          builder: (ctx) => AlertDialog(
            ...
            content: const Text('No existe una cuenta con ese correo. ¿Deseas registrarte?'),
            actions: [
      ...
      // Navigate to sign up screen with pre-filled email
                  Navigator.of(context).push(MaterialPageRoute(builder: (_) => SignUpScreen(onSuccess: () {}, initialEmail: email)));
                },
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: FilledButton(
                        ...
                        child: _loading ? const SizedBox(height: 18, width: 18, child: CircularProgressIndicator(strokeWidth: 2)) : const Text('Log In'),
                      ),
                    ),
                    const SizedBox(height: 8),
                    SizedBox(
                    ...
                    TextButton(
                      onPressed: () {
                        // Show TOS / privacy small dialog
                        showDialog<void>(
                          context: context,
                          builder: (_) => AlertDialog(
                            title: const Text('Privacy'),
                            content: const Text('By continuing you agree to our Terms of Service and Privacy Policy.'),
                            actions: [TextButton(onPressed: () => Navigator.of(context).pop(), child: const Text('Close'))],
                          ),
                        );
                      },
                      child: const Text('Terms & Privacy', style: TextStyle(fontSize: 12)),
                    )
                  ],
                ),
              ),
